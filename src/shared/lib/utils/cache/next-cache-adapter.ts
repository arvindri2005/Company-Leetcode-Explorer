...
export class NextCacheAdapter implements CacheAdapter {
  ...
  /**
   * @deprecated Use revalidateCacheTag from '@/shared/lib/utils/cache/server-cache' instead.
  ...
  revalidateTag(_tag: string): void {
    throw new Error(
      ...
      "Use revalidateCacheTag from '@/shared/lib/utils/cache/server-cache' in Server Actions instead."
    );
  }
}
