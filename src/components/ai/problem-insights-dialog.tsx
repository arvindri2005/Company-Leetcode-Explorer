...
const InsightsContent = ({
        ...
        return (
            <div className="flex flex-col items-center justify-center py-12 space-y-4 text-center">
                ...
                <p className="text-muted-foreground max-w-sm">
                    We couldn't generate insights for this problem at the
                    moment. This could be a temporary issue. Please try again
                    later.
                </p>
            </div>
        );
    ...
    return (
        <div className="space-y-4 py-2">
            ...
            {insights.commonAlgorithms &&
                insights.commonAlgorithms.length > 0 && (
                    <InsightSection
                ...
                <DialogContent className="bg-card border border-border rounded-xl mb-8 shadow-sm max-w-3xl w-[95vw] md:w-full max-h-[90vh] flex flex-col p-0">
                    <DialogHeader className="p-6 pb-4 flex-shrink-0">
                        ...
                        <DialogDescription className="text-sm">
                            Key concepts, common approaches, and a hint to guide
                            your thinking.
                        </DialogDescription>
                    </DialogHeader>
    ...
    return (
        ...
        >
            <DrawerContent className="bg-card border border-border rounded-xl shadow-sm">
                ...
                <div
                    className="overflow-y-auto px-6 max-h-[60vh]"
                    data-vaul-no-drag
                >
                    <InsightsContent
                        insights={insights}
