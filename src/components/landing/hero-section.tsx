    ...
    >
      ...
      <div className="max-w-[800px] z-[2]">
        ...
        <div className="flex gap-4 justify-center flex-wrap animate-fadeInUp animation-delay-400">
          <button
            className="px-8 py-4 border-none rounded-full text-lg font-semibold cursor-pointer transition-all duration-300 no-underline inline-flex items-center gap-2 bg-gradient-to-r from-[#00d4aa] to-[#7c3aed] text-white hover:transform hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,212,170,0.3)]"
            onClick={handleClick}
          >
            <FaRocket />
            Start Exploring
