...
export default function MockInterviewPage({ params }: MockInterviewPageProps) {
  ...
  const [problem, setProblem] = useState<LeetCodeProblem | null | undefined>(
    undefined,
  );
    ...
    return (
      <div className="text-center py-10">
        ...
        <p className="text-muted-foreground mb-6">
          The company with slug "{params.companySlug}" could not be found.
        </p>
    ...
    return (
      <div className="text-center py-10">
        <h1 className="text-2xl font-bold mb-4">
          Problem Not Found for {company.name}
        </h1>
        <p className="text-muted-foreground mb-6">
          The problem you are looking for (Slug: {params.problemSlug}) does not
          exist for {company.name}.
        </p>
        <Button asChild variant="outline">
    ...
    <section className="space-y-6 flex flex-col h-full">
      <div className="flex-shrink-0">
        ...
        <p className="text-muted-foreground">
          Practice solving this problem with an AI interviewer. Often asked by{" "}
          {company.name}.
        </p>
      </div>
