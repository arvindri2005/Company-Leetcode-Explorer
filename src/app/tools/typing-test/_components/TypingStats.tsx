  ...
  return (
    <div className="flex gap-3 sm:gap-6 bg-background/40 backdrop-blur-md px-6 py-3 rounded-full border border-white/10 shadow-lg">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col leading-none">
             <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">Acc</span>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col leading-none">
            <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">Err</span>
