...
export const metadata: Metadata = {
  ...
  description:
    "Upload an Excel (.xlsx) or CSV (.csv) file to add multiple LeetCode problems.",
  robots: {
    index: false,
    follow: false,
  },
    ...
    <section className="space-y-8 max-w-3xl mx-auto">
      <div>
        <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
          Bulk Add LeetCode Problems (Admin)
        </h1>
        <p className="mt-2 text-lg text-muted-foreground">
          Upload an Excel (.xlsx) or CSV (.csv) file to add multiple problems at
          once.
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
          ...
          following headers:{" "}
          <strong>
            Title, Difficulty, Link, Tags, Company Name, Last Asked Period
          </strong>
          .
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
          Accepted values for Difficulty: Easy, Medium, Hard. The 'Tags' column
          can be left empty.
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
          Accepted values for Last Asked Period: last_30_days, within_3_months,
          within_6_months, older_than_6_months.
        </p>
      </div>
      <Separator />
