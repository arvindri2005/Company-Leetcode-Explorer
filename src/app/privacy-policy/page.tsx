    ...
    return (
        <div className="bg-background w-full">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-foreground">
                ...
                <p className="mt-4 text-muted-foreground">Last updated: July 26, 2024</p>

                <div className="mt-8 prose prose-lg max-w-none">
                    <p>
                        Welcome to Byte To Offer (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services (collectively, the &quot;Services&quot;).
                    </p>

                    <h2 className="mt-8 text-2xl font-bold">1. Information We Collect</h2>
                    <p>
                        We may collect personal information that you voluntarily provide to us when you register for an account, use our Services, or contact us. This may include:
                    </p>
                    <ul>
                        <li><strong>Personal Identification Information:</strong> Name, email address, and profile picture.</li>
                        <li><strong>User Content:</strong> Any information you provide while using our AI-powered features, such as mock interview responses or problem-solving notes.</li>
                        <li><strong>Usage Data:</strong> Information about how you use the Services, such as the features you use, the pages you visit, and the time and date of your visits.</li>
                    </ul>
                    ...
                    <h2 className="mt-8 text-2xl font-bold">3. Data Sharing and Disclosure</h2>
                    <p>
                    ...
                    <ul>
                        ...
                        <li><strong>For Legal Reasons:</strong> We may share your information when we believe it is necessary to comply with a legal obligation, protect our rights or property, or prevent illegal activities.</li>
                    ...
                    <h2 className="mt-8 text-2xl font-bold">5. Your Data Protection Rights</h2>
                    <p>
                    ...
                    <h2 className="mt-8 text-2xl font-bold">6. Changes to This Privacy Policy</h2>
                    <p>
