...
import { getCompanies } from '@/lib/data'; // To pass to the form for company name validation hint

export const metadata = {
  title: 'Bulk Add LeetCode Problems',
  description: 'Upload an Excel file to add multiple LeetCode problems.',
};

export default async function BulkAddProblemsPage() {
  // Fetch a reasonable number of company names for hint display
    ...
    <section className="space-y-8 max-w-3xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Upload an Excel (.xlsx) file to add multiple problems at once.
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
          Ensure your Excel file's first sheet has the following headers: <strong>Title, Difficulty, Link, Tags, Company Name, Last Asked Period</strong>.
        </p>
         <p className="mt-1 text-sm text-muted-foreground">
          Accepted values for Difficulty: Easy, Medium, Hard.
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
