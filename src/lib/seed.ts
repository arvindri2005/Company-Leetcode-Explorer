...
const initialCompaniesData: Omit<Company, "id">[] = [
  {
    ...
    description: "Focuses on algorithms, data structures, and system design.",
  ...
  },
  {
    ...
    description:
      "Often asks about data structures, algorithms, and leadership principles.",
  ...
  },
  {
    ...
    description:
      "Covers a broad range of topics including OS, networking, and DS/Algo.",
  ...
  },
  {
    ...
    description:
      "Strong emphasis on algorithms, system design, and product sense.",
  ...
  },
  {
    ...
    description:
      "Known for questions on data structures, algorithms, and iOS/macOS specifics.",
...
const initialProblemsData: (Omit<
  LeetCodeProblem,
  "id" | "normalizedTitle"
> & {
  ...
  },
  {
    ...
    normalizedTitle: "merge k sorted lists",
    ...
    companyId: "google",
    companySlug: "google",
    lastAskedPeriod: "within_3_months",
  },
  {
    ...
    companyId: "google",
    companySlug: "google",
    lastAskedPeriod: "within_6_months",
  },
  {
    title: "Number of Islands",
    normalizedTitle: "number of islands",
    ...
    companyId: "google",
    companySlug: "google",
    lastAskedPeriod: "older_than_6_months",
  },
  {
    title: "Kth Largest Element in an Array",
    normalizedTitle: "kth largest element in an array",
  ...
  },
  {
    ...
    normalizedTitle: "reorder data in log files",
  ...
  },
  {
    ...
    normalizedTitle: "critical connections in a network",
  ...
  },
  {
    ...
    normalizedTitle: "reverse linked list",
  ...
  },
  {
    ...
    normalizedTitle: "validate binary search tree",
  ...
  },
  {
    ...
    normalizedTitle: "serialize and deserialize binary tree",
  ...
  },
  {
    ...
    normalizedTitle: "copy list with random pointer",
  ...
  },
  {
    ...
    normalizedTitle: "product of array except self",
  ...
  },
  {
    ...
    normalizedTitle: "binary tree right side view",
  ...
  },
  {
    ...
    normalizedTitle: "find median from data stream",
  ...
  },
  {
    ...
    normalizedTitle: "meeting rooms ii",
...
export async function seedDatabase() {
  if (!db) {
    console.error("Firestore database instance is not available. Aborting seed.");
    return;
  }
    ...
    initialCompaniesData.forEach((companyData) => {
      ...
      if (companyIdToUse) {
        ...
        const dataToSet: Company = {
          ...
          normalizedName:
            companyData.normalizedName || companyNameToSeed.toLowerCase(),
        ...
        console.warn(
          `Company ID for ${companyNameToSeed} not found in mapping. Skipping.`,
        );
      }
    });
  } else {
  ...
  if (problemsSnapshot.empty) {
    ...
    console.log(
      "Problems collection is not empty. Skipping problem seeding. If you need to update existing problems with normalizedTitle, a migration script would be required.",
    );
  }
  ...
  try {
    await batch.commit();
    console.log(
      "Database batch commit successful (data written if collections were empty).",
    );
  } catch (error) {
